...
!cp -r /vols/Scratch/asteel/uzayScripts/scripts_templates/scripts/mrsiBeta/preProc/19102017/hlsvdpro_copy .
cc= struct;
...
%%
    dw_Subtract = -squeeze(img1(:,:,:,1:2:end))+...
        1.005*squeeze(img1(:,:,:,2:2:end));


%%

save(['_subtract_' outName '.mat'],'dw_Subtract','img_dw_90_water','mvmt','img1')
dw_mean_hlsvd = hlsvdProc(dw_Subtract,'_temp');
if ave == 1
    img_water = img_dw_90_water;
    save(['_subtract_hlsvd_' outName '.mat'],'dw_mean_hlsvd','img_water','mvmt','img1')
end
%end
%%
if ave == 1

    dw_mean_hlsvd = mean(dw_mean_hlsvd,4);
