function [mappedX, conn_comp] = landmark_isomap(X, no_dims, k, percentage); 
%ISOMAP Runs the Isomap algorithm
%
%   [mappedX, conn_comp] = landmark_isomap(X, no_dims, k, percentage); 
%
...
% of this component are returned in conn_comp.
%
%
