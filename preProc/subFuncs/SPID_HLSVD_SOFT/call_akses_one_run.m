...
[load_saved_signal,baseline_boolean,allow_change_damp,allow_change_freq,...
 phasedistort,plotting,signal_type,bsline_type,noise_level,lambda,maxiter]= ...
...
% construct database
filtertype = 'fir';
[dbase,abs_scl_factor,name_metabolite] = read_dbase(nrp,filtertype,0,'');
...
% call fakses function
  [recon,baseline,filrecon,filbaseline,original,filter_information,...
   ...
   CR_error_all,individual_components,residual] = ...
