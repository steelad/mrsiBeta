...
elseif TEB == 110
    tes_basis(1).te= '/home/fs0/asteel/scratch/uzayScripts/scripts_templates/scripts/mrsiBeta/misc/3T_slaser110ms_1250_oxford_2HG_mNAA';
else
    assert('TE not supported or not specified.')
end
